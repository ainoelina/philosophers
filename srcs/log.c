...
/*   Updated: 2021/10/15 12:15:54 by avuorio       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	print_log(t_rules *rules, int status, int id)
{
	...
	if (status == EAT)
		printf("%3lli Philosopher %i is eating\n", time, id + 1);
	else if (status == SLEEP)
		printf("%3lli Philosopher %i is sleeping\n", time, id + 1);
	else if (status == THINK)
		printf("%3lli Philosopher %i is thinking\n", time, id + 1);
	else if (status == DED)
		printf ("%3lli Philosopher %i had died\n", time, id + 1);
	else if (status == FORK)
		printf ("%3lli Philosopher %i has taken a fork\n", time, id + 1);
	else if (status == FINISHED)
		printf ("%3lli All philosophers have been fed\n", time);
	return (0);
}
